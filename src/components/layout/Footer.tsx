...
export default function Footer() {
  return (
    <footer style={{
      background: 'linear-gradient(180deg, #0D0B1A 0%, #080816 100%)',
      padding: '3rem 2rem',
      display: 'flex',
      ...
      {/* Fort silhouette */}
      <svg style={{ position: 'absolute', bottom: 0, left: 0, right: 0, opacity: 0.1 }} viewBox="0 0 1440 60" preserveAspectRatio="none">
        <path
