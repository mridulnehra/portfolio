...
export default function Navbar() {
  ...
  return (
    <nav style={{
      ...
      borderBottom: scrolled ? '1px solid rgba(139, 26, 26, 0.08)' : '1px solid transparent',
      ...
      <a href="#hero" style={{
        ...
        <span style={{ color: 'var(--color-accent-maroon)' }}>✦</span> {SITE_CONFIG.name}
      </a>
      ...
      <div style={{
        ...
        {navLinks.map(link => (
          <a key={link.name} href={link.href} style={{
            ...
            color: activeSection === link.href.slice(1) ? 'var(--color-accent-maroon)' : 'var(--color-text-muted)',
            textDecoration: 'none',
      ...
      >
        <div style={{
          width: 20, height: 2, background: 'var(--color-text-primary)',
